...
CREATE TABLE "new_day_habits" (
    ...
    CONSTRAINT "day_habits_day_id_fkey" FOREIGN KEY ("day_id") REFERENCES "habit_week_days" ("id") ON DELETE RESTRICT ON UPDATE CASCADE,
...
INSERT INTO "new_days" ("habit_id", "id", "week_day") SELECT "habit_id", "id", "week_day" FROM "days";
DROP TABLE "days";
ALTER TABLE "new_days" RENAME TO "days";
CREATE UNIQUE INDEX "days_habit_id_week_day_key" ON "days"("habit_id", "week_day");
